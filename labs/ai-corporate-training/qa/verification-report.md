...
フェーズ1では2回デプロイしている（1回目のあとにオーナー確認で FAQ の
見出し追加が入ったため）。

| 回 | 版 | 内容 | アップロード |
| --- | --- | --- | --- |
| 1回目 | `f2aabd2c-3ead-45d2-9305-308521f8d46e` | `169a499`（初回のソフトローンチ） | 4ファイル |
| **2回目（現行）** | **`218a6e77-6eea-4487-bdcd-0d97074a4f74`** | `72f2675`（FAQ の見出し追加） | **2ファイル**（`index.html` ＋ `BUILD_ID`） |

切り戻し先の版: `f2aabd2c-3ead-45d2-9305-308521f8d46e`（1回目）。
そこからさらに戻すなら `566a82b4-c428-40ae-8f38-dfd321040a53`（法人LP追加前）。
