...
const SUITES = [
  ...
  { name: 'event-capacity', file: 'unit/event-capacity.mjs', kind: 'unit' },
  ...
  { name: 'event-calendar-note', file: 'unit/event-calendar-note.mjs', kind: 'unit' },
  ...
  { name: 'auth-verify-cache', file: 'unit/auth-verify-cache.mjs', kind: 'unit' },
  { name: 'stripe-relay', file: 'unit/stripe-relay.mjs', kind: 'unit' },
