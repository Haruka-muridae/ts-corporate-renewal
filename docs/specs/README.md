...
| [potenitas-infinity-hero-v1.md](./potenitas-infinity-hero-v1.md) | POTENITAS INFINITY LP のファーストビュー（`public/potenitas/infinity/`。公開URL `/potenitas/infinity/`）。背景画像の上で `POTENITAS INFINITY` が焔から形成され、サブコピーが続く約 4 秒の演出（CSS ＋ Canvas 2D） | v1.0 |
