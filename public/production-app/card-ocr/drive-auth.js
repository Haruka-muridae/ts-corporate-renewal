 ...
 * 複製元
 * ==================================================================
 * public/production-app/card-ocr/poc/drive-auth.js を複製（2026-08-04）。
 * その元は public/apps/drive-auth.js。**どちらも import はしない。**
 * （docs/repository-structure.md §2-1・§4-1）
 *
 * PoC からの変更:
 *   - 設定の参照先を ./config.js に変えた
 *   - 期限の余裕（EXPIRY_MARGIN）を config.js へ移した
 *   - 通信の中断（AbortSignal）に合わせ、認可も中断できるようにした
 * ==================================================================
 *
 * ==================================================================
