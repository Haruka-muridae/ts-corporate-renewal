/*
 * Drive API v3 の下回り（通信・エラー分類）。
 *
 * ==================================================================
 * 複製元
 * ==================================================================
 * ../card-ocr/drive-api.js を複製（2026-08-10）。**import はしない**
 * （docs/repository-structure.md §4-1）。
 *
 * 複製元から変えたところ:
 *   - **書き込み系（アップロード・フォルダ作成・削除）を持たない。**
 *     このアプリは台帳を読むだけで、ドライブに何も作らない。
 *     使わない道具を持ち込むと「作らない」という要件が守られているかを
 *     コードから読み取れなくなる。
 * ==================================================================
 *
 * ==================================================================
 ...
 * fetch する」だけで、Sheets にも Gmail にも使える。エラー分類も共通で効く。
 */
