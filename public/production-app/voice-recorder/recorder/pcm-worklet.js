/*
 * AudioWorkletProcessor（要件書 §FR-04）。
 ...
 *
 * public/apps/voice-recorder/pcm-worklet.js からの複製（内容は同一）。
 * AudioWorkletGlobalScope では import が使えないため、この0.2秒という値は
 * ../config.js からではなくここに置いている。変えるときは要件書 §FR-04 も直すこと。
 */
